...
const API =
  process.env.REACT_APP_HOST || "https://mid-project-01.herokuapp.com";
...
console.log(response.body.token,'tooooken')
  ...
  const signup = async (
    ...
    const response = await superagent.post(`${API}/signup`, object);
    console.log(response,'resssss');
    // login(response.body.username,response.body.password)
